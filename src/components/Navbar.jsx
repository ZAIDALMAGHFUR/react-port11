...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full left-0 top-0 z-[999] ${sticky ? "backdrop-blur-lg  text-white" : "text-white"}`}>
      <div className="flex items-center justify-between">
        ...
        <div className={` ${sticky ? "md:bg-white/0 bg-white" : "bg-black"} text-white md:block hidden px-7 py-2 font-medium  rounded-bl-full`}>
